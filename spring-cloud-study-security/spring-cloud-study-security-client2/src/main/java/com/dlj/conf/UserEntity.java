...
public class UserEntity implements UserDetails, CredentialsContainer {
    ...
    private static Log logger = LogFactory.getLog(UserEntity.class);
     ...
     * </p>
     * <p>
     * Creates a UserEntity and automatically encodes the provided password using
     * {@code PasswordEncoderFactories.createDelegatingPasswordEncoder()}. For example:
     * </p>
     *
     * <pre>
     * <code>
     * UserDetails UserEntity = UserEntity.withDefaultPasswordEncoder()
     *     .username("user")
     *     .password("password")
     *     .roles("USER")
     *     .build();
     ...
     * <pre>
     * <code>
     * UserDetails UserEntity = UserEntity.withUsername("user")
    ...
    public static UserBuilder withDefaultPasswordEncoder() {
        logger.warn("UserEntity.withDefaultPasswordEncoder() is considered unsafe for production and is only intended for sample applications.");
        PasswordEncoder encoder = PasswordEncoderFactories.createDelegatingPasswordEncoder();
    ...
    /**
     * Builds the UserEntity to be added. At minimum the username, password, and authorities
    ...
    public static class UserBuilder {
         ...
         * </p>
         *
         * @param roles the roles for this UserEntity (i.e. USER, ADMIN, etc). Cannot be null,
         ...
         *
         * @param authorities the authorities for this UserEntity. Cannot be null, or contain
         *                    null values
         * @return the {@link UserBuilder} for method chaining (i.e. to populate
         * additional attributes for this user)
         * @see #roles(String...)
         ...
         * Populates the authorities. This attribute is required.
         *
         * @param authorities the authorities for this UserEntity (i.e. ROLE_USER, ROLE_ADMIN,
